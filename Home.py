...
st.write('# Hunger Zero!')
st.write('## The best place to discover your newest favorite restaurant!')
st.write('### We have the following brands within our platform:')

col1, col2, col3, col4, col5 = st.columns(5)

with col1:
  restaurantes_cadastrados = df2['restaurant_id'].nunique()
  col1.metric('Registered Restaurants', restaurantes_cadastrados)

with col2:
  paises_cadastrados = df2['country'].nunique()
  col2.metric('Registered Countries', paises_cadastrados)

with col3:
  cidades_cadastradas = df2['city'].nunique()
  col3.metric('Registered Cities', cidades_cadastradas)

with col4:
  total_votes = df2['votes'].sum()
  col4.metric('Reviews on the platform', "{:,}".format(total_votes).replace(",", "."))

with col5:
  total_cuisines = df2['cuisines'].nunique()
  col5.metric('Types of Cuisine', total_cuisines)
...
st.write('###### LinkedIn - https://www.linkedin.com/in/thiago-panazzo/')
st.write('###### GitHub - https://github.com/Tpanazzo/')