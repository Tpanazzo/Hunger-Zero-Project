...
with st.container():
   ...
   with col1:
      ...
      fig = px.bar(
        ...
        x='city',
        y='restaurant_id', text='restaurant_id', color='country',
        title='Top 7 Cities with the Most Restaurants Rated Above 4.0',
        labels={
            'city': 'City',
            'restaurant_id': 'Restaurants',
            'country': 'Country'
   ...
   with col2:
      ...
      fig = px.bar(
        ...
        x='city',
        y='restaurant_id', text='restaurant_id', color='country',
        title='Top 7 Cities with the Most Restaurants Rated Below 2.5',
        labels={
            'city': 'City',
            'restaurant_id': 'Restaurants',
            'country': 'Country'
...
with st.container():
   ...
   fig = px.bar(
      ...
      title='Top 10 Cities with the Most Distinct Culinary Types',
      labels={
         'city': 'City',
         'cuisines': 'Culinary Types',
         'country': 'Country'
    })
   st.plotly_chart(fig, use_container_width=True)