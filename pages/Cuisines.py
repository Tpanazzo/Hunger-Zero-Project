...
restaurant_slider = st.sidebar.slider(
    "Select the number of restaurants you wish to view.", 1, 20, 10
)
...
st.markdown("# 🍽️ Cuisine View")
st.markdown('## Top restaurants of the main culinary types')


st.markdown(f'## Top {restaurant_slider} Restaurants')
